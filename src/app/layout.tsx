...
export const metadata: Metadata = {
  title: "Taller Mecánico Barcelona | Reparación Profesional en Les Corts",  description: "Taller mecánico honesto en Barcelona (Av. Sarrià). Reparaciones rápidas, diagnóstico profesional y precios justos. 4.6★ en Google. Llama: 933 21 76 48",  keywords: "taller mecánico Barcelona, reparación coches Les Corts, mecánico Eixample, diagnóstico coche Barcelona, servicio reparación vehículos",  metadataBase: new URL("https://tallersavsarria.com"),
  alternates: {
    canonical: "https://tallersavsarria.com"},
  openGraph: {
    title: "Tallers Av Sarrià | Taller Mecánico de Confianza en Barcelona",    description: "Diagnóstico profesional, reparaciones rápidas y precios justos en Barcelona. 4.6★ Google Reviews.",    url: "https://tallersavsarria.com",    siteName: "Tallers Av Sarrià",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/male-worker-wearing-work-clothes_273609-10811.jpg",        alt: "Taller mecánico profesional"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "Tallers Av Sarrià | Mecánico de Confianza",    description: "Reparaciones profesionales en Barcelona. Llamar: 933 21 76 48",    images: ["http://img.b2bpic.net/free-photo/male-worker-wearing-work-clothes_273609-10811.jpg"],
  },
  robots: {
    index: true,
    follow: true,
